...
btnEnviar.onclick = (evento) => {
  evento.preventDefault(); //Impeque que a página seja recarregada / previne comportamento padrão
  ...
  let inputIsVegan = document.querySelector('input[name="vegano"]:checked')
